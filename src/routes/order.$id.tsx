...
function OrderPage() {
  ...
  return (
    <section className="px-4 md:px-8 mt-8 md:mt-12 max-w-3xl mx-auto">
      ...
      <div className="text-mono text-[11px] tracking-[0.3em] text-secondary mb-2">◢ ORDER CONFIRMED</div>
      <h1 className="text-display text-5xl md:text-7xl">YOU'RE IN.</h1>
      ...
      <div className="mt-10 grid md:grid-cols-2 gap-6">
        ...
        <div className="border border-border p-5 bg-surface">
          ...
          <div className="text-sm text-muted-foreground text-mono">{order.paymentId}</div>
      ...
      <div className="mt-8 flex gap-3">
        <Link to="/account" className="flex-1 text-center bg-foreground text-background h-12 inline-flex items-center justify-center text-mono text-xs tracking-widest hover:bg-primary hover:text-primary-foreground">VIEW ORDERS</Link>
        <Link to="/shop" className="flex-1 text-center border border-border h-12 inline-flex items-center justify-center text-mono text-xs tracking-widest hover:border-primary hover:text-primary">KEEP SHOPPING</Link>
      </div>
    </section>
  );
}
